...
class RegisterViewController: UIViewController {
    ...
    private var userProfilePict: UIImageView = {
    ...
    func setView(){
        view.addSubview(userProfilePict)
    ...
    func setConstraints(){
        NSLayoutConstraint.activate([
            ...
            userProfilePict.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -250),
            userProfilePict.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            userProfilePict.widthAnchor.constraint(equalToConstant: 100),
            userProfilePict.heightAnchor.constraint(equalToConstant: 100),
            
            lblLogin.topAnchor.constraint(equalTo: userProfilePict.bottomAnchor, constant: 30),
    ...
    func setAction() {
        ...
        let gestureProfile = UITapGestureRecognizer(target: self, action: #selector(didChooseProfilePict))
        userProfilePict.addGestureRecognizer(gestureProfile)
    }
    
    @objc func didChooseProfilePict(){
        print("Masuk Sini")
    }
